...
const services = [
  {
    id: 1,
    titleUz: "Магнитно-резонансная томография (МРТ)",
    titleRu: "Кардиология",
    titleEn: "Cardiology",
  ...
  {
    id: 4,
    titleUz: "Лабораторная диагностика",
    titleRu: "Неврология",
    titleEn: "Neurology",
  ...
  // qo‘shimcha hospital xizmatlarini shu yerga kiritavering
];
